...
export class Button {
    ...
    render() {
        ...
        return (h(Host, null,
            h("button", { ref: ref => (this.button = ref), disabled: !!this.disabled, class: `btn smt-btn btn--${this.theme} smt-btn--${this.theme}
           d-inline-flex align-items-center ${this.size &&
    ...
    static get is() { return "smt-main-button"; }
